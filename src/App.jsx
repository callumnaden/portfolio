      ...
      <div className="header">
          ...
          variants={ChildVarients}>
                <div className="light-link" onClick={() => setDarkMode(prevMode => !prevMode)} >
                  ...
                  {darkMode ? <svg className="light-img" width="39" height="46" viewBox="0 0 39 46" fill="none" xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
                  viewBox="0 0 24 24">
                  ...
                  <svg className="light-img" width="39" height="46" viewBox="0 0 39 46" fill="none" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
